...
public class HolidayController {
    ...
    @GetMapping("/last3/{countryCode}") // e.g. /api/holidays/recent
    ...
    @GetMapping("/non-weekend-count") // e.g. /api/holidays/non-weekend
    ...
    @GetMapping("/deduplicated") // e.g. /api/holidays/common
